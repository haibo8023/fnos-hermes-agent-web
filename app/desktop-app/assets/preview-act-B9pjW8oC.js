...
})()`}async function K(e,t,n){n.amount;let r=await V(e,G());if(r.kind===`failed`)return{error:r.error,success:!1};if(r.kind===`silent`)return{acted:`scrolled`,note:j,success:!0};let i=r.result;if(!i.span)return{...i,acted:`scrolled the page`,note:`The page has nothing to scroll — it all fits already.`};!g()&&i.point&&await y(t,i.point),await x(t,n.amount??i.page??600);let a=await V(e,z(E));return a.kind===`answered`?{...a.result,acted:`scrolled the page`,success:!0}:{acted:`scrolled the page`,note:j,success:!0}}async function q(r){let i=T.find(e=>e===r.kind);if(i){let e=t();return e?(e[i](),{acted:i,note:`Page is loading — call elements to see what is on it.`,success:!0}):{error:A,success:!1}}let a=e();if(!a)return{error:A,success:!1};let o=r;if(o.kind===`pin`||o.kind===`unpin`||o.kind===`hold`||o.kind===`strobe`){let e=await V(a,o.kind===`hold`?I():o.kind===`strobe`?L():o.kind===`pin`?F(o,o.text||``):R(o));return e.kind===`failed`?{error:e.error,success:!1}:e.kind===`answered`?e.result:{acted:o.kind,note:j,success:!0}}let s=n();if(s&&O.indexOf(o.kind)!==-1)return U(a,s,o);if(o.kind===`scroll`&&!o.to&&!o.ref&&!o.selector&&s)return K(a,s,o);let c=await V(a,B(o,o.kind===`elements`?0:E));return c.kind===`failed`?{error:c.error,success:!1}:c.kind===`silent`?{acted:o.kind,note:j,success:!0}:c.result}export{q as actOnActivePreview};